/******************************************************************************
	...
	SDL2 UI drawing functions

******************************************************************************/

#ifndef SDL2_UI_DRAW_H
#define SDL2_UI_DRAW_H
...
#define ui_clear_rect(frame, no, rect)	video_fill_rect(frame, MAKECOL32(ui_palette[no].r,ui_palette[no].g,ui_palette[no].b), rect)
