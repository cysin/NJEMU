...
#elif defined(SDL2) && !USE_CACHE
// SDL2 doesn't need PSP memory pool - will use malloc
// Define dummy variables for compatibility
UINT32 psp2k_mem_offset = 0;
INT32 psp2k_mem_left = 0;
#endif
...
#ifdef SDL2
	// SDL2: Use malloc to allocate graphics memory
	memory_region_gfx1 = (UINT8 *)malloc(memory_length_gfx1);
