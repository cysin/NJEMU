...
int sound_init(void)
{
	...
	printf("[DEBUG] sound_init() called\n");
	fflush(stdout);
	...
	printf("[DEBUG] sound_init: Calling sound_thread_start()\n");
	fflush(stdout);
	result = sound_thread_start();
	printf("[DEBUG] sound_init: sound_thread_start() returned %d\n", result);
	fflush(stdout);
